...

{
	...
	case WM_CREATE:
	{
		...
		/*HANDLE hImage0 = (HBITMAP)LoadImage
		(
			GetModuleHandle(NULL),
...
VOID ApplyTheme(const std::string& themeName)
{
	if (themeName == "Square Blue")
	{
		...
		HBITMAP hBtn1_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_1_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn2_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_2_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn3_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_3_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn4_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_4_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn5_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_5_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn6_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_6_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn7_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_7_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn8_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_8_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn9_SB = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_9_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
	}
	else if (themeName == "Metal Mistral")
	{
		...
		HBITMAP hBtn1_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_1_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn2_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_2_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn3_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_3_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn4_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_4_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn5_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_5_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn6_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_6_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn7_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_7_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn8_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_8_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
		HBITMAP hBtn9_MM = (HBITMAP)LoadImage(hThemesDLL, MAKEINTRESOURCE(IDB_BUTTON_9_SB), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE);
